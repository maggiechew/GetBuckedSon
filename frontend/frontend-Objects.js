let gotBuckedMessage = `





____    ____  ___           _______   ______   .___________.   .______    __    __    ______  __  ___  _______  _______              _______.  ______   .__   __.  __  
\\   \\  /   / /   \\         /  _____| /  __  \\  |           |   |   _  \\  |  |  |  |  /      ||  |/  / |   ____||       \\            /       | /  __  \\  |  \\ |  | |  | 
 \\   \\/   / /  ^  \\       |  |  __  |  |  |  |  ---|  |----    |  |_)  | |  |  |  | |  ,----'|  '  /  |  |__   |  .--.  |          |   (---- |  |  |  | |   \\|  | |  | 
  \\_    _/ /  /_\\  \\      |  | |_ | |  |  |  |     |  |        |   _  <  |  |  |  | |  |     |    <   |   __|  |  |  |  |           \\   \\    |  |  |  | |  .    | |  | 
    |  |  /  _____  \\     |  |__| | |   --'  |     |  |        |  |_)  | |   --'  | |   ----.|  .  \\  |  |____ |  '--'  | __    .----)   |   |   --'  | |  |\\   | |__| 
    |__| /__/     \\__\\     \\______|  \\______/      |__|        |______/   \\______/   \\______||__|\\__\\ |_______||_______/ (_ )   |_______/     \\______/  |__| \\__| (__) 
                                                                                                                          |/                                           
...
let tooLate = `
                                        ...
                                        ______   ___    ___       _       ____  ______    ___  __ 
                                        |      | /   \\  /   \\     | |     /    ||      |  /  _]|  |
                                        |      ||     ||     |    | |    |  o  ||      | /  [_ |  |
                                        |_|  |_||  O  ||  O  |    | |___ |     ||_|  |_||    _]|__|
                                          |  |  |     ||     |    |     ||  _  |  |  |  |   [_  __ 
                                          |  |  |     ||     |    |     ||  |  |  |  |  |     ||  |
                                          |__|   \\___/  \\___/     |_____||__|__|  |__|  |_____||__|
...
export {gotBuckedMessage, loserImage, winnerMessage, winnerImage, welcomeImage, tutorial, menu, turningLeft, turningRight, leanedRight, leanedLeft, wrong, tooLate, correct}